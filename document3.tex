...
\section{Conclusion}
This manual is just one way to implement a network, there are many possible ways of going about setting up a network. This is the set up that worked for us based on our business requirements. Throughout working on the project as a team we built up many skills: time management, TeXstudio, team building, conflict resolution. The biggest challenge during this project was allocating the time to work on it outside of class, another challenge we faced was having enough resources to work with: routers, switches, end devices.
